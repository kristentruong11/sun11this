 ...
 * - Presents a few quick actions tailored by role.
 */
export default function EmptyState({
  ...
  const handleQuickReply = (prompt) => {
    if (typeof onQuickReply === "function" && prompt) {
      onQuickReply(prompt);
    }
  };

  const roleTitle =
    userRole === "teacher" ? "👨‍🏫 Tính năng cho giáo viên" : "🎓 Tính năng cho học sinh";
  ...
  return (
    ...
    >
      ...
      <p
        className={`mb-6 sm:mb-8 max-w-md text-sm sm:text-base ${
      ...
      <div
        className={`mt-4 sm:mt-6 p-3 sm:p-4 rounded-lg max-w-md ${
